...
> 当前全局阶段：**Q1–Q4 已完成最终方法说明、写作材料包与数字冻结；Q4 固定为候选、风险边界与 pilot 接口。下一阶段进入统一论文写作与独立审计。**
...
| G4.5 结果人工判断 | ✅（Q1–Q4） | Q1–Q4 均已完成方法、结果、假设与主张范围裁决 |
| G4 结果冻结 | ✅ | Q1–Q4 均已生成 frozen_numbers |
| G5 论文分节 | 可进入 | 四问均具备 writer package，开始统一论文写作与审计 |
...
|---|---|---|---|---|
| Q1 | [06] 数字已冻结（中等可信） | 27 个重复策略；19 对重复策略的 Spearman 区间跨0 | M2 正文；M1 基础描述；M3 一致性核对；F1–F3已删除 | 可进入论文分节写作 |

"""Q2 PoC M1: policy-group OOF main-effect Ridge on frozen official labels."""
...
print(json.dumps({"candidate": "Q2-M1", "n_cells": len(train), "n_policy_groups": int(pd.Series(groups).nunique()), "rmse_log": rmse_log, "mae_log": mae_log}, ensure_ascii=False))
